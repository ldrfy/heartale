...
def get_by_gitee():
    ...
    Returns:
        dict/str/None: 更新信息，网络错误的None,无须理会，str为错误信息
    """
    url = "https://gitee.com/yuhldr/heartale/raw/main/data/version.json"
...
def get_by_github():
    ...
    Returns:
        dict/str/None: 更新信息，网络错误的None,无须理会，str为错误信息
    """
    url = "https://raw.githubusercontent.com/ldrfy/heartale/main/data/version.json"
